...
public class JNumberField extends javax.swing.JFormattedTextField {
	...
	/**
	 * Creates a <code>JNumberField</code> with a <code>DecimalFormat</code> and
	 * initial value.
	 *
	 * @param number
	...
	/**
	 * Sets the text of this <code>TextComponent</code> to the specified number.
	 * If the number is <code>null</code> or empty, has the effect of simply
	 * deleting the old text. When number has been inserted, the resulting caret
	 * location is determined by the implementation of the caret class.
	 * <p>
	 * This method is thread safe, although most Swing methods are not. Please
	 * see Threads and Swing for more information.
	 *
	 * @param number
	...
	/**
	 * Returns the <code>Number</code> contained in this
	 * <code>TextComponent</code>. If the underlying document is empty, will
	 * give a <code>NumberFormatException</code>.
	 *
	 * @return the number
	...
	/**
	 * Returns the <code>byte</code> contained in this
	 * <code>TextComponent</code>. If the underlying document is empty, will
	 * give a <code>NumberFormatException</code>.
	 *
	 * @return the number
	...
	/**
	 * Returns the <code>double</code> contained in this
	 * <code>TextComponent</code>. If the underlying document is empty, will
	 * give a <code>NumberFormatException</code>.
	 *
	 * @return the number
	...
	/**
	 * Returns the <code>float</code> contained in this
	 * <code>TextComponent</code>. If the underlying document is empty, will
	 * give a <code>NumberFormatException</code>.
	 *
	 * @return the number
	 ...
	 * . If the underlying document is empty, will give a
	...
	/**
	 * Returns the <code>long</code> contained in this
	 * <code>TextComponent</code>. If the underlying document is empty, will
	 * give a <code>NumberFormatException</code>.
	 *
	 * @return the number
	...
	/**
	 * Returns the <code>short</code> contained in this
	 * <code>TextComponent</code>. If the underlying document is empty, will
	 * give a <code>NumberFormatException</code>.
	 *
	 * @return the number
